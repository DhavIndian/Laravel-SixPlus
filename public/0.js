  ...
  methods: {
    ...
    fetchbyid: function fetchbyid(id) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default()({
        ...
        _this2.url = resp.data.data.image;
      })["catch"](function (err) {});
    },
    closebtn: function closebtn() {
      ...
      this.$nextTick(function () {
        _this3.uploadReady = true;
      });
    },
    changetitile: function changetitile() {
      this.closebtn();
      ...
      _c("div", { staticClass: "container-fluid" }, [
        _c("div", { staticClass: "card" }, [
              ...
              "button",
              {
                ...
                on: {
                  click: function($event) {
                    return _vm.$refs.child.changetitile()
                  }
                }
              },
              [_vm._v("Insert")]
          ...
          _c(
            ...
            [
              !_vm.dash
                ? _c("BulletList-loader", {
                    attrs: { speed: 2, animate: true }
                  })
                : _c(
                    "table",
                    { staticClass: "table" },
                          ...
                          _c("td", [
                            _c(
                              "button",
                              {
                                ...
                                on: {
                                  click: function($event) {
                                    return _vm.$refs.child.fetchbyid(d.id)
                                  }
                                }
                              },
                              [_vm._v("Edit")]
